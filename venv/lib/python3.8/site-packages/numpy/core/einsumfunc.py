    ...
    *operands : list of array_like
    ...
    >>> print(path_info[1]) 
      ...
      Optimized FLOP count:  8.000e+05
       Theoretical speedup.txt:  1000.000
    ...
    path_print += "   Theoretical speedup.txt:  %3.3f\n" % speedup
...
def einsum(*operands, **kwargs):
    ...
    * Chained array operations, in efficient calculation order, :py:func:`numpy.einsum_path`.
    ...
    can greatly increase the computational efficiency.txt at the cost of a larger
